...
class Ui_Maker_Dialog(object):
    def setupUi(self, Maker_Dialog):
        ...
        self.silhouetteLabel.setGeometry(QtCore.QRect(475, 590, 250, 250))
        font = QtGui.QFont()
        ...
        self.silhouetteTextLabel.setGeometry(QtCore.QRect(540, 560, 120, 23))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.skeletonLabel.setGeometry(QtCore.QRect(775, 590, 250, 250))
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.skeletonTextLabel.setGeometry(QtCore.QRect(840, 560, 120, 23))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.getSilhouetteButton.setGeometry(QtCore.QRect(455, 850, 140, 45))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.saveSilhouetteButton.setGeometry(QtCore.QRect(605, 850, 140, 45))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.saveSkeletonButton.setGeometry(QtCore.QRect(905, 850, 140, 45))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.getSkeletonButton.setGeometry(QtCore.QRect(755, 850, 140, 45))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.keywordComboBox = QtWidgets.QComboBox(Maker_Dialog)
        self.keywordComboBox.setGeometry(QtCore.QRect(1103, 645, 180, 42))
        self.keywordComboBox.setObjectName("keywordComboBox")
        self.keywordLabel = QtWidgets.QLabel(Maker_Dialog)
        self.keywordLabel.setGeometry(QtCore.QRect(1103, 600, 180, 23))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.flipButton = QtWidgets.QPushButton(Maker_Dialog)
        self.flipButton.setGeometry(QtCore.QRect(1100, 412, 180, 42))
        font = QtGui.QFont()
        font.setPointSize(14)
    ...
    def retranslateUi(self, Maker_Dialog):
        ...
        self.keywordLabel.setText(_translate("Maker_Dialog", "Keyword"))
